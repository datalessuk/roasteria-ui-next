...
const singleOriginOptions: IDropDownOption[] = [
  { value: "true", text: "Single Origin" },
  { value: "false", text: "Blends" },
];

export function SingleOriginFilter({ control, origin }: FlavorFilterProps) {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between space-x-4 px-4">
        <h4 className="text-sm font-semibold">Coffee Type</h4>
                  ...
                  <FormItem>
                    <FormControl>
                      <DropDown
                        ...
                        dropDownOptions={singleOriginOptions}
